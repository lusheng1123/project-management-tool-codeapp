...
describe('MODELS', () => {
  it('has all 12 tables', () => {
    const tables = ['pm_resource', 'pm_capability', 'pm_product', 'pm_requirement', 'pm_project', 'pm_control', 'pm_epic', 'pm_userstory', 'pm_risk', 'pm_dependency', 'pm_capabilityproduct']
    tables.forEach(t => {
